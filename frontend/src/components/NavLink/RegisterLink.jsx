...
export default function RegisterLink() {
  return (
    <div className="group relative flex cursor-pointer flex-col items-center justify-center rounded-xl border border-blue-200 bg-[#2F5F98] px-6 py-8 text-center shadow-md transition-all duration-200 hover:scale-105 hover:shadow-lg">
      {/* Recommended badge */}

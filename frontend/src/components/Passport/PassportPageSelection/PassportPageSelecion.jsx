...
import { setSelectedDocument } from "../../../store/slice/passportSlice";
...
export default function PassportPageSelection({ onNext }) {
    ...
    <div className="min-h-screen w-full bg-white px-6 py-6">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
          <div>
            <div className="mb-8 flex items-center gap-3 rounded-lg bg-blue-50 px-5 py-4">
            ...
            <div className="mb-8 flex flex-col items-center gap-6 sm:flex-row sm:justify-center sm:gap-10">
              <RadioOption
                ...
                onClick={() => handleDocumentSelect("34")}
              />

              <RadioOption
                label="Ordinary 66 pages"
                selected={selectedDocument === "66"}
                onClick={() => handleDocumentSelect("66")}
              />
            </div>
          </div>
